...
cd Render
blenderproc run --custom-blender-path /home/martyn/Downloads/blender-3.1.1-linux-x64/ render_custom_templates.py --output_dir $OUTPUT_DIR --cad_path $CAD_PATH --colorize True  
...
export SEG_PATH=$OUTPUT_DIR/sam6d_results/manual_detection.json
