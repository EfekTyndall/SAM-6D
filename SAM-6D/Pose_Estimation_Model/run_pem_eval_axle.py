...
def overlay_point_cloud(image, pred_rot, pred_trans, point_cloud_path, K, save_path, alpha=0.6):
    """
    ...
    blended_image = cv2.addWeighted(overlayed_image, alpha, rgb, 1 - alpha, 0)
...
if __name__ == "__main__":
    ...
    vis_overlay = overlay_point_cloud(
        img,
        pred_rot[valid_masks][0],
        pred_trans[valid_masks][0],
        point_cloud_path,
        selected_K,
        save_path_overlay
    )
